                        ...
                        <a href="!#">
                            ...
                            <div className="tit-box">
                                <ul>
                                    ...
                                    <li>{item.제품특성}</li>
                                    <li><span className='rate-price'>{item.할인율===0 ? `` :`${Math.round(item.할인율*100)}%`}</span>{item.할인율 > 0 &&(<span className='pan-price'>{commaPrice`${Math.round(item.정가*(1-item.할인율))}원`}</span>)}</li>
